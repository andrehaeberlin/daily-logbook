# file: app_v3_1.py
"""
Diário de Bordo Contemporâneo v3.2.0 — A4 Landscape
Atualizações (v3.2.0, calibradas com folha v3.0.0 impressa e anotada à mão):
  - REF movido para a linha dos pomodoros: a linha REF dedicada do Ouro
    foi riscada na folha e "REF:" foi escrito à direita das caixas.
  - REF em todas as prioridades: a folha ganhou "REF:" manuscrito após
    os pomodoros de Prata, Bronze e Cobre.
  - Nova prioridade 5. ESTANHO (ID + pomodoros + REF), escrita à mão
    abaixo do Cobre na folha ("5. Estanho: / POM...").
  - Alturas da coluna 2 recalculadas (prio_h 196→200) mantendo os
    9 blocos horários e o ★ Amanhã Começa Com.
Herdado da v3.0.0: seletor de dia da semana (SEG-DOM), campos ID nas
prioridades, pomodoros enxutos, layout em 3 colunas da v2.2.0.
"""
...
def draw_sections(c, cursor):
    ...
    # ── Amanhã Começa Com (rodapé da coluna)
